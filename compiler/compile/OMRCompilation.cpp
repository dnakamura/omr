...
#if defined(AIXPPC) || defined(LINUX) || defined(J9ZOS390) || defined(OMRWINDOWS)
...
#endif /* defined(AIXPPC) || defined(LINUX) || defined(J9ZOS390) || defined(OMRWINDOWS) */
...
#elif defined(LINUX) || defined(J9ZOS390) || defined(OMRWINDOWS)
   if (self()->getOption(TR_DebugBeforeCompile))
      {
...
#endif /* defined(LINUX) || defined(J9ZOS390) || defined(OMRWINDOWS) */
