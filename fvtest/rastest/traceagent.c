...
#if defined(LINUX) || defined(AIXPPC) || defined(OMRWINDOWS) || defined(OSX)
	if (OMR_ERROR_NONE == testRc) {
...
#if defined(LINUX) || defined(AIXPPC)|| defined(OMRWINDOWS)
	if (OMR_ERROR_NONE == testRc) {
...
#endif /* defined(LINUX) || defined(AIXPPC) || defined(OMRWINDOWS) */
#endif /* defined(LINUX) || defined(AIXPPC) || defined(OMRWINDOWS) || defined(OSX) */
	return testRc;
}
...
#elif !defined(LINUX) && !defined(OMRWINDOWS) && !defined(OSX)
	if (OMR_ERROR_NONE == testRc) {
