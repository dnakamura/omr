...
public:
	...
	void shouldSetCPUAffinity(bool setCPUAffinity) { _cpuAffinityDisabled = !setCPUAffinity;}
	void shouldSetCPUAffinity() const  { return !_cpuAffinityDisabled;};
